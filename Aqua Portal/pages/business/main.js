...
// const deleteCompanyDetails = document.getElementById("deleteCompanyDetails");
...
//     if (e.target === createCompanyModal) createCompanyModal.style.display = "none";
//     if (e.target === deleteCompanyModal) deleteCompanyModal.style.display = "none";
// });

// // ======================= LOGO PREVIEW + SIZE CHECK =======================
...
//         alert("");
//         companyLogo.value = "";
//         logoPreviewImg.src = "https://i.ibb.co/Vp7J0b7/upload.png";
//         return;
//     }
...
//     // STRICT RULE: ONLY ONE COMPANY
//     if (localStorage.getItem(COMPANY_KEY)) {
//         alert("Only one company account allowed!");
//         return;
//     }

//     const companyName = document.getElementById("companyName").value.trim();
//     const mailingName = document.getElementById("mailingName").value.trim();
//     const address = document.getElementById("companyAddress").value.trim();
//     const mobile = document.getElementById("mobileNumber").value.trim();
//     const fax = document.getElementById("faxNumber").value.trim();
//     const cin = document.getElementById("cinNumber").value.trim();
...
//     // Mailing Name strict rule
//     const lowerMail = mailingName.toLowerCase();
//     if (!(lowerMail.includes("ptv") || lowerMail.includes("ltd") || lowerMail.includes("govt"))) {
//         alert("Mailing Name must include: ptv OR ltd OR govt");
//         return;
//     }

//     // Mobile strict validation
//     if (!/^[0-9]{10,15}$/.test(mobile)) {
//         alert("Mobile number must be numeric and 10 to 15 digits.");
//         return;
//     }

//     // CIN strict validation
//     if (cin.length < 5) {
//         alert("CIN Number looks invalid!");
//         return;
//     }
...
//         alert("Financial Year format must be like 2025-2026");
//         return;
//     }
...
// // ======================= DELETE DETAILS SHOW =======================
// function showDeleteCompanyDetails() {
//     const companyData = JSON.parse(localStorage.getItem(COMPANY_KEY));

//     if (!companyData) {
//         deleteCompanyDetails.innerHTML = "<p>No company found!</p>";
//         return;
//     }

//     deleteCompanyDetails.innerHTML = `
//     <img src="${companyData.logo}" alt="Logo">
//     <p><b>Company Name:</b> ${companyData.companyName}</p>
//     <p><b>Mailing Name:</b> ${companyData.mailingName}</p>
//     <p><b>Address:</b> ${companyData.address}</p>
//     <p><b>Mobile:</b> ${companyData.mobile}</p>
//     <p><b>Fax:</b> ${companyData.fax}</p>
//     <p><b>CIN:</b> ${companyData.cin}</p>
//     <p><b>Email:</b> ${companyData.email}</p>
//     <p><b>Website:</b> ${companyData.website}</p>
//     <p><b>Financial Year:</b> ${companyData.financialYear}</p>
//     <p><b>Stock Type:</b> ${companyData.stockType}</p>
//     <p><b>Created At:</b> ${companyData.createdAt}</p>
//   `;
// }
...
// // ======================= MY COMPANY REDIRECT =======================
// myCompanyBtn.addEventListener("click", () => {
//     const companyData = JSON.parse(localStorage.getItem(COMPANY_KEY));

//     if (!companyData) {
//         alert("No company found. Create company first!");
//         return;
//     }

//     if (companyData.stockType === "Account Only") {
//         window.location.href = "./Business Assets/account-only.html";
//     } else if (companyData.stockType === "Account With Inventory") {
//         alert("Inventory page not created yet. You must build it next.");
//     } else {
//         alert("Invalid Stock Type!");
//     }
// });
