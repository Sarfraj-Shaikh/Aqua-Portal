...
## Access
Is page ko access karne ke liye user ka account hona zaroori hai.  

Agar user ka account nahi hoga, toh wo is page ko access nahi kar sakta.

## Company Creation
Company create karte time same **CIN**, **FAX**, **Mobile Number**, **Email ID**, **Name**, aur **Website** se koi existing company details available nahi honi chahiye.  

Agar same details already present hain, toh un details ke through company create nahi ki ja sakti, kyunki isse duplicate entries block ki jaati hain.

## Fully Customisation
User apni company details ko kabhi bhi **edit/update** ya **delete** kar sakta hai.

## Confirmation
Company details ko **edit/update** ya **delete** karne se pehle confirmation liya jata hai, taaki by mistake click hone par direct action perform na ho.

## Limitation
Ek user ek account se sirf **ek hi company** create kar sakta hai.

## Redirection
**Account Only** aur **Account With Inventory** dono categories ke liye alag-alag page par redirection kiya jata hai.  
