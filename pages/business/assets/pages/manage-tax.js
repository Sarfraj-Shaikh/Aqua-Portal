        ...
        for (let i = 0; i < taxSetup.length; i++) {
            ...
            if (taxSetup[i].taxCreator === currentUser) {
                ...
                <div class="uom-card">
                        ...
                        <h2 class="title">${taxSetup[i].taxName}</h2>
                        <p class="desc">Percentage: ${taxSetup[i].taxPercent}%</p>
...
function deleteCard(index) {
    ...
    popupMessage.textContent = "Are You Want To Sure To Delete This Tax Details?";
...
function openEditModal(index) {
    ...
    editSystem.value = taxSetup[index].taxName;
    editName.value = taxSetup[index].taxPercent;
...
function saveChanges(index) {
    ...
    if (editSystem.value.trim() === "") {
        ...
        if (editName.value.trim() === "") {
            ...
            if (taxSetup[index].taxCreator === currentUser) {

                taxSetup[index].taxName = editSystem.value;
                taxSetup[index].taxPercent = editName.value;
...
function searchUom() {
    ...
    for (let i = 0; i < taxSetup.length; i++) {
        ...
        let symbol = taxSetup[i].taxName.toLowerCase();
        let name = taxSetup[i].taxPercent.toLowerCase();
